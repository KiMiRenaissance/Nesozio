  ...
  render() {
    ...
    container.innerHTML = `
      <div class="row mb-4 animate-fade-in-up">
        <div class="col-12">
          <div style="background:linear-gradient(135deg,var(--primary),var(--primary-dark),#7c3aed);border-radius:var(--radius-lg);padding:2.5rem;color:white;position:relative;overflow:hidden;">
      ...
      <div class="animate-fade-in-up">
        ...
        <div class="row g-3">
          ${PRODUCTS.slice(0, 4).map(p => {
            ...
            return `
              <div class="col-6 col-md-3">
                <div class="product-card h-100" onclick="window.location.href='../product/product.html?id=${p.id}'" style="cursor:pointer;">
            ...
            return `
              <div class="col-6 col-md-4 col-lg-3">
                <div class="product-card h-100">
                  <div class="product-image-wrapper" onclick="window.location.href='../product/product.html?id=${p.id}'" style="cursor:pointer;">
                  ...
                  <div class="product-body">
                    ...
                    <button class="btn-detail mt-2" onclick="window.location.href='../product/product.html?id=${p.id}'">Lihat Detail</button>
                  </div>
                </div>
              </div>
            `;
